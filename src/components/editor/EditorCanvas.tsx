...
function SortableBlock({
    ...
    return (
        <div
            ...
            className={`group relative transition-all ${isDragging ? 'z-50 opacity-60' : ''
                } ${isSelected
...
export function EditorCanvas({
    ...
    return (
        <div className="flex flex-1 flex-col overflow-hidden">
            ...
            <div
                ref={canvasRef}
                className="relative flex-1 overflow-y-auto bg-[#1a1a2e] p-8"
            ...
            >
                ...
                <div
                    ref={setNodeRef}
                    className={`mx-auto min-h-[600px] rounded-lg border-2 border-dashed p-8 transition-all ${isOver
